    ...
    <tr>
        <div class="dtree">
            <script type="text/javascript">
                ...
                d.add('010302', '0103', '课程类别', '${pageContext.request.contextPath}/education/courseTypeAction_findAll.action', '', 'right');
                d.add('0104', '01', '就业部');
                ...
                d.add('010502', '0105', '职务管理', '${pageContext.request.contextPath}/hr/postAction_findAll.action', '', 'right');
                d.add('010503', '0105', '员工管理', '${pageContext.request.contextPath}/hr/staffAction_findAll.action', '', 'right');
