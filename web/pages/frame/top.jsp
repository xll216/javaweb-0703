                                    ...
                                    <div align="right">
                                        <table border="0" width="215" cellspacing="0" cellpadding="0" id="table6"
                                            ...
                                            <tr>
                                                <td width="51" valign="middle">
                                                    <font color="#FFFFFF">
                                                        欢迎您： <s:property value="#session.loginName"/>
                                                    </font>
                                                </td>
                                            </tr>
                                        </table>
                                        ...
                                        <table border="0" width="215" cellspacing="0" cellpadding="0" id="table6"
                                            ...
                                            <tr>
                                                <td width="51" valign="middle">
                                                    ...
                                                    --%>
                                                    <a href="${pageContext.request.contextPath}/hr/staffAction_updPwd.action"
                                                       target="right">
                                                        <font color="ffffff">更改密码</font>
                                                    </a>
                                                </td>
                                                <td width="55" valign="middle"><a
                                                        href="${pageContext.request.contextPath}/hr/staffAction_logout.action"
